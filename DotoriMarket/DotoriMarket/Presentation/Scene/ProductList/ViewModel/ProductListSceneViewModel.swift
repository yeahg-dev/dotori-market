...
final class ProductListSceneViewModel {
    ...
    func transform(input: Input) -> Output {
        ...
        let navigationBarComponent = self.productListUsecase
            ...
            .asDriver(
                onErrorJustReturn: NavigationBarComponentViewModel(
                    title: "보기",
        ...
        return Output(
            ...
            willStartLoadingIndicator: willStartLoadingIndicator.asDriver(
                onErrorJustReturn: ()),
            willEndLoadingIndicator: willEndLoadingIndicator.asDriver(
                onErrorJustReturn: ()),
            products: products,
            listViewWillEndRefresh: endRefresh,
            pushProductDetailView: pushProductDetailView,
            networkErrorAlert: networkErrorAlert.asDriver(
                onErrorJustReturn: NetworkErrorAlertViewModel() as AlertViewModel))
    }
